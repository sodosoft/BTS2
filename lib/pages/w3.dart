...
void main() => runApp(const MaterialApp(home: WebViewCost()));
...
class WebViewCost extends StatefulWidget {
  const WebViewCost({super.key});

  @override
  State<WebViewCost> createState() => _WebViewState();
}

class _WebViewState extends State<WebViewCost> {
